...
public class CoalesceScalarFunction_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_c0sw9s_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_c0sw9s_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_c0sw9s_a0(EditorContext editorContext, SNode node) {
