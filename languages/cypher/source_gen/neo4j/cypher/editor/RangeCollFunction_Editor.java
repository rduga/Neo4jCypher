...
public class RangeCollFunction_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_amm6b9_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_amm6b9_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_amm6b9_a0(EditorContext editorContext, SNode node) {
