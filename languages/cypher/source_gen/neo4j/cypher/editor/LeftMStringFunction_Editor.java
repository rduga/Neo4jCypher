...
public class LeftMStringFunction_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_t2x98u_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConceptProperty_t2x98u_a0(editorContext, node));
  ...
  private EditorCell createConceptProperty_t2x98u_a0(EditorContext editorContext, SNode node) {
