...
public class Index_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createAlternation_vwx1p9_a(EditorContext editorContext, SNode node) {
    ...
    if (alternationCondition) {
      ...
      editorCell = this.createConceptProperty_vwx1p9_a0(editorContext, node);
    }
    return editorCell;
  }
  ...
  private EditorCell createConceptProperty_vwx1p9_a0(EditorContext editorContext, SNode node) {
