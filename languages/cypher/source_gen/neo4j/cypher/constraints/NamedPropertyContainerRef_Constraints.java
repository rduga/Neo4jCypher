...
public class NamedPropertyContainerRef_Constraints extends BaseConstraintsDescriptor {
  private static Logger LOG = Logger.getLogger(NamedPropertyContainerRef_Constraints.class);
                ...
                if (addAll) {
                  ListSequence.fromList(nodes).addSequence(ListSequence.fromList(SNodeOperations.getDescendants(it, "neo4j.cypher.structure.IPropertyContainer", false, new String[]{})).where(new IWhereFilter<SNode>() {
                    public boolean accept(SNode it) {
                      return isNotEmpty_gvwt0r_a0a0a0a0a0a0a0j0a0a0a0m0a0a0a0b0a1a0b0a(SPropertyOperations.getString(it, "name"));
                    }
                  }));
                }
              }
  ...
  public static boolean isNotEmpty_gvwt0r_a0a0a0a0a0a0a0a0a0a0b0a1a0b0a(String str) {
    return str != null && str.length() > 0;
  }

  public static boolean isNotEmpty_gvwt0r_a0a0a0a0a0a0a0j0a0a0a0m0a0a0a0b0a1a0b0a(String str) {
    return str != null && str.length() > 0;
  }
}
