...
public class OrderByStatement_Constraints extends BaseConstraintsDescriptor {
  ...
  public OrderByStatement_Constraints() {
    super("neo4j.cypher.structure.OrderByStatement");
  }
  ...
  public static boolean static_canBeAParent(SNode node, SNode childNode, SNode childConcept, SNode link, final IOperationContext operationContext) {
    return SConceptOperations.isSubConceptOf(childConcept, "neo4j.cypher.structure.IOrderByExpression") || SConceptOperations.isSubConceptOf(childConcept, "jetbrains.mps.baseLanguage.structure.DotExpression");
  }
}
