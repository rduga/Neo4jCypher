...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 75:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedNodeRef", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.IMatchExpression"}, new String[]{}, new String[]{"node"});
      case 76:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedPathRef", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.IReturnExpression"}, new String[]{}, new String[]{"pathExpression"});
      case 77:
      ...
      case 79:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.Node", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.IPropertyContainer", "neo4j.cypher.structure.IMatchExpression"}, new String[]{}, new String[]{});
      case 80:
      ...
      case 85:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.PathExpression", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.INamedIdentifier"}, new String[]{"named"}, new String[]{});
      case 86:
      ...
      case 103:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.Relationship", "jetbrains.mps.baseLanguage.structure.BinaryOperation", false, new String[]{"jetbrains.mps.baseLanguage.structure.BinaryOperation", "neo4j.cypher.structure.IPropertyContainer", "neo4j.cypher.structure.IMatchExpression"}, new String[]{"concrete", "specifyHops", "minHops", "maxHops"}, new String[]{});
      case 104:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.RelationshipType", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "jetbrains.mps.baseLanguage.structure.IValidIdentifier", "neo4j.cypher.structure.IMatchExpression", "neo4j.cypher.structure.IInnerMatchExpression"}, new String[]{}, new String[]{});
      case 105:
