...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"neo4j.cypher.structure.AggregateFunction", "neo4j.cypher.structure.AllIndex", "neo4j.cypher.structure.AssignmentStatement", "neo4j.cypher.structure.ConnectionSheet", "neo4j.cypher.structure.ConnectionStatement", "neo4j.cypher.structure.CountAllAggregate", "neo4j.cypher.structure.CypherExpression", "neo4j.cypher.structure.DistinctReturnExpression", "neo4j.cypher.structure.EmbeddedConnection", "neo4j.cypher.structure.EmptyConnectionStatement", "neo4j.cypher.structure.Function", "neo4j.cypher.structure.IConnectionStatement", "neo4j.cypher.structure.IQueryStatement", "neo4j.cypher.structure.IdIndex", "neo4j.cypher.structure.ImpermanentConnection", "neo4j.cypher.structure.Index", "neo4j.cypher.structure.KeyValueIndex", "neo4j.cypher.structure.LuceneIndex", "neo4j.cypher.structure.MatchExpression", "neo4j.cypher.structure.MaxAggregate", "neo4j.cypher.structure.MinAggregate", "neo4j.cypher.structure.NamedIndex", "neo4j.cypher.structure.NamedNode", "neo4j.cypher.structure.NamedNodeRef", "neo4j.cypher.structure.NamedNodeRefProperty", "neo4j.cypher.structure.NamedNodeRefPropertyRef", "neo4j.cypher.structure.NamedTypedLRRelationship", "neo4j.cypher.structure.NamedTypedRLRelationship", "neo4j.cypher.structure.NamedTypedRelationship", "neo4j.cypher.structure.NamedUntypedLRRelationship", "neo4j.cypher.structure.NamedUntypedRLRelationship", "neo4j.cypher.structure.NamedUntypedRelationship", "neo4j.cypher.structure.Node", "neo4j.cypher.structure.OrderByExpression", "neo4j.cypher.structure.Property", "neo4j.cypher.structure.PropertyContainer", "neo4j.cypher.structure.QueryEmptyStatement", "neo4j.cypher.structure.QueryExpression", "neo4j.cypher.structure.QuerySheet", "neo4j.cypher.structure.QueryStatement", "neo4j.cypher.structure.ReadOnlyQueryExpression", "neo4j.cypher.structure.ReadWriteQueryExpression", "neo4j.cypher.structure.Relationship", "neo4j.cypher.structure.RelationshipType", "neo4j.cypher.structure.ReturnExpression", "neo4j.cypher.structure.SumAggregate", "neo4j.cypher.structure.UnnamedNode", "neo4j.cypher.structure.UnnamedTypedLRRelationship", "neo4j.cypher.structure.UnnamedTypedRLRelationship", "neo4j.cypher.structure.UnnamedTypedRelationship", "neo4j.cypher.structure.UnnamedUntypedLRRelationship", "neo4j.cypher.structure.UnnamedUntypedRLRelationship", "neo4j.cypher.structure.UnnamedUntypedRelationship", "neo4j.cypher.structure.WhereExpression"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 5:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.CountAllAggregate", "neo4j.cypher.structure.AggregateFunction", false, new String[]{"neo4j.cypher.structure.AggregateFunction"}, new String[]{}, new String[]{});
      case 6:
      ...
      case 7:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.DistinctReturnExpression", "neo4j.cypher.structure.ReturnExpression", false, new String[]{"neo4j.cypher.structure.ReturnExpression"}, new String[]{}, new String[]{});
      case 8:
      ...
      case 10:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.Function", "neo4j.cypher.structure.CypherExpression", false, new String[]{"neo4j.cypher.structure.CypherExpression"}, new String[]{}, new String[]{});
      case 11:
      ...
      case 18:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.MatchExpression", "neo4j.cypher.structure.CypherExpression", false, new String[]{"neo4j.cypher.structure.CypherExpression"}, new String[]{}, new String[]{});
      case 19:
      ...
      case 22:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedNode", "neo4j.cypher.structure.Node", false, new String[]{"neo4j.cypher.structure.Node", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 23:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedNodeRef", "neo4j.cypher.structure.ReturnExpression", false, new String[]{"neo4j.cypher.structure.ReturnExpression"}, new String[]{}, new String[]{"node"});
      case 24:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedNodeRefProperty", "neo4j.cypher.structure.ReturnExpression", false, new String[]{"neo4j.cypher.structure.ReturnExpression"}, new String[]{}, new String[]{"namedNode"});
      case 25:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedNodeRefPropertyRef", "neo4j.cypher.structure.ReturnExpression", false, new String[]{"neo4j.cypher.structure.ReturnExpression"}, new String[]{}, new String[]{"namedNode", "property"});
      case 26:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedTypedLRRelationship", "neo4j.cypher.structure.Relationship", false, new String[]{"neo4j.cypher.structure.Relationship"}, new String[]{}, new String[]{});
      case 27:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedTypedRLRelationship", "neo4j.cypher.structure.Relationship", false, new String[]{"neo4j.cypher.structure.Relationship"}, new String[]{}, new String[]{});
      case 28:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedTypedRelationship", "neo4j.cypher.structure.Relationship", false, new String[]{"neo4j.cypher.structure.Relationship"}, new String[]{}, new String[]{});
      case 29:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedUntypedLRRelationship", "neo4j.cypher.structure.Relationship", false, new String[]{"neo4j.cypher.structure.Relationship"}, new String[]{}, new String[]{});
      case 30:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedUntypedRLRelationship", "neo4j.cypher.structure.Relationship", false, new String[]{"neo4j.cypher.structure.Relationship"}, new String[]{}, new String[]{});
      case 31:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.NamedUntypedRelationship", "neo4j.cypher.structure.Relationship", false, new String[]{"neo4j.cypher.structure.Relationship"}, new String[]{}, new String[]{});
      case 32:
      ...
      case 33:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.OrderByExpression", "neo4j.cypher.structure.CypherExpression", false, new String[]{"neo4j.cypher.structure.CypherExpression"}, new String[]{}, new String[]{});
      case 34:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.Property", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 35:
      ...
      case 37:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.QueryExpression", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression"}, new String[]{"skipItems", "limitItems"}, new String[]{});
      case 38:
      ...
      case 42:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.Relationship", "neo4j.cypher.structure.PropertyContainer", false, new String[]{"neo4j.cypher.structure.PropertyContainer", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 43:
      ...
      case 44:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.ReturnExpression", "neo4j.cypher.structure.CypherExpression", false, new String[]{"neo4j.cypher.structure.CypherExpression"}, new String[]{}, new String[]{});
      case 45:
      ...
      case 53:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.WhereExpression", "neo4j.cypher.structure.CypherExpression", false, new String[]{"neo4j.cypher.structure.CypherExpression"}, new String[]{}, new String[]{});
      default:
