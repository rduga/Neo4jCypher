...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"neo4j.cypher.structure.AggregateFunction", "neo4j.cypher.structure.AllIndex", "neo4j.cypher.structure.AscOrderBy", "neo4j.cypher.structure.AssignmentStatement", "neo4j.cypher.structure.ConnectionSheet", "neo4j.cypher.structure.ConnectionStatement", "neo4j.cypher.structure.CountAggregate", "neo4j.cypher.structure.CountAllAggregate", "neo4j.cypher.structure.CypherDotExpression", "neo4j.cypher.structure.CypherExpression", "neo4j.cypher.structure.CypherStatement", "neo4j.cypher.structure.DescOrderBy", "neo4j.cypher.structure.DistinctReturnExpression", "neo4j.cypher.structure.EmbeddedConnection", "neo4j.cypher.structure.EmptyConnectionStatement", "neo4j.cypher.structure.Function", "neo4j.cypher.structure.IConnectionStatement", "neo4j.cypher.structure.ICypherExpression", "neo4j.cypher.structure.IOrderByExpression", "neo4j.cypher.structure.IQueryStatement", "neo4j.cypher.structure.IReturnExpression", "neo4j.cypher.structure.IdIndex", "neo4j.cypher.structure.ImpermanentConnection", "neo4j.cypher.structure.Index", "neo4j.cypher.structure.KeyValueIndex", "neo4j.cypher.structure.LuceneIndex", "neo4j.cypher.structure.MatchExpression", "neo4j.cypher.structure.MaxAggregate", "neo4j.cypher.structure.MinAggregate", "neo4j.cypher.structure.NamedIndex", "neo4j.cypher.structure.NamedNode", "neo4j.cypher.structure.NamedNodeRef", "neo4j.cypher.structure.NamedTypedLRRelationship", "neo4j.cypher.structure.NamedTypedRLRelationship", "neo4j.cypher.structure.NamedTypedRelationship", "neo4j.cypher.structure.NamedUntypedLRRelationship", "neo4j.cypher.structure.NamedUntypedRLRelationship", "neo4j.cypher.structure.NamedUntypedRelationship", "neo4j.cypher.structure.Node", "neo4j.cypher.structure.OrderByExpression", "neo4j.cypher.structure.OrderByStatement", "neo4j.cypher.structure.Property", "neo4j.cypher.structure.PropertyContainer", "neo4j.cypher.structure.QueryEmptyStatement", "neo4j.cypher.structure.QueryExpression", "neo4j.cypher.structure.QuerySheet", "neo4j.cypher.structure.QueryStatement", "neo4j.cypher.structure.ReadOnlyQueryExpression", "neo4j.cypher.structure.ReadWriteQueryExpression", "neo4j.cypher.structure.Relationship", "neo4j.cypher.structure.RelationshipType", "neo4j.cypher.structure.ReturnStatement", "neo4j.cypher.structure.StartStatement", "neo4j.cypher.structure.SumAggregate", "neo4j.cypher.structure.UnnamedNode", "neo4j.cypher.structure.UnnamedTypedLRRelationship", "neo4j.cypher.structure.UnnamedTypedRLRelationship", "neo4j.cypher.structure.UnnamedTypedRelationship", "neo4j.cypher.structure.UnnamedUntypedLRRelationship", "neo4j.cypher.structure.UnnamedUntypedRLRelationship", "neo4j.cypher.structure.UnnamedUntypedRelationship", "neo4j.cypher.structure.WhereExpression"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 12:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.DistinctReturnExpression", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.IReturnExpression"}, new String[]{}, new String[]{});
      case 13:
      ...
      case 26:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.MatchExpression", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.ICypherExpression"}, new String[]{}, new String[]{});
      case 27:
      ...
      case 41:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.Property", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept", "jetbrains.mps.baseLanguage.structure.IOperation"}, new String[]{}, new String[]{});
      case 42:
      ...
      case 61:
        return new CompiledConceptDescriptor("neo4j.cypher.structure.WhereExpression", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression", "neo4j.cypher.structure.ICypherExpression"}, new String[]{}, new String[]{});
      default:
