...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 60:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.IQueryStatement").interface_().create();
      case 61:
      ...
      case 107:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.QueryEmptyStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "neo4j.cypher.structure.IQueryStatement").create();
      case 108:
      ...
      case 110:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.QueryStatement").super_("jetbrains.mps.baseLanguage.structure.Statement").parents("jetbrains.mps.baseLanguage.structure.Statement", "jetbrains.mps.baseLanguage.structure.IValidIdentifier", "neo4j.cypher.structure.IQueryStatement").children(new String[]{"queryExpression"}, new boolean[]{false}).alias("query", "").create();
      case 111:
      ...
      case 147:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.WriteOnlyQueryExpression").super_("neo4j.cypher.structure.QueryExpression").parents("neo4j.cypher.structure.QueryExpression").children(new String[]{"createStatement", "writeStatement"}, new boolean[]{false, true}).alias("woq", "").create();
      default:
