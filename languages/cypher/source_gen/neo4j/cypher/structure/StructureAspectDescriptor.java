...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 33:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.CypherQueryExecuteMethod").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").alias("execute()", "").create();
      case 34:
      ...
      case 37:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.CypherResultIteratorHasNextMethod").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").alias("hasNext()", "").create();
      case 38:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.CypherResultIteratorMethod").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").alias("iterator", "").create();
      case 39:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.CypherResultIteratorNextMethod").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.baseLanguage.structure.IOperation").alias("next()", "").create();
      case 40:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.CypherResultIteratorTupleType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").children(new String[]{"tupleType"}, new boolean[]{false}).alias("cypherResultIteratorTupleType", "").create();
      case 41:
        return new ConceptDescriptorBuilder("neo4j.cypher.structure.CypherResultRowTupleType").super_("jetbrains.mps.baseLanguage.structure.Type").parents("jetbrains.mps.baseLanguage.structure.Type").children(new String[]{"tupleType"}, new boolean[]{false}).alias("cypherResultRowTupleType", "").create();
      case 42:
