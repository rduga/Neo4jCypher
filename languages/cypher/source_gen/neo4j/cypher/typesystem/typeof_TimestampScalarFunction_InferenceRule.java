...
public class typeof_TimestampScalarFunction_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode timestampScalarFunction, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:1549d4d9-195d-4192-a8ca-9bdca0139ffa(neo4j.cypher.typesystem)", "4409026550618781198", true), (SNode) new typeof_TimestampScalarFunction_InferenceRule.QuotationClass_lpqmgh_a0a0a0().createNode(typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_lpqmgh_a0a0a0 {
    public QuotationClass_lpqmgh_a0a0a0() {
    }
