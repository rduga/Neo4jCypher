...
public class typeof_QueryTupleExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode queryTupleExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    ListSequence.fromList(SLinkOperations.getTargets(returnStatement, "returnExpression", true)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        ListSequence.fromList(memberTypes).addElement(typeCheckingContext.typeOf(it, "r:1549d4d9-195d-4192-a8ca-9bdca0139ffa(neo4j.cypher.typesystem)", "5915353355201263953", true));
      }
    });
...

    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:1549d4d9-195d-4192-a8ca-9bdca0139ffa(neo4j.cypher.typesystem)", "5915353355195737404", true), (SNode) _quotation_createNode_2z3nj2_a0i0b(memberTypes), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_2z3nj2_a0i0b(Object parameter_1) {
