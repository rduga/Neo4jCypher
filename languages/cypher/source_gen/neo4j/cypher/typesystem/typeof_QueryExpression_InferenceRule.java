...
public class typeof_QueryExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode queryExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:1549d4d9-195d-4192-a8ca-9bdca0139ffa(neo4j.cypher.typesystem)", "1160499357071254466", true), (SNode) new typeof_QueryExpression_InferenceRule.QuotationClass_cuqbfo_a0a0a0().createNode(typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_cuqbfo_a0a0a0 {
    public QuotationClass_cuqbfo_a0a0a0() {
    }
